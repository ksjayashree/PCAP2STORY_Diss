...
res = subprocess.run(["wsl", "docker", "exec", "clab-pcap2story-rr1", "vtysh", "-c", "show bgp l2vpn evpn route"], capture_output=True, text=True)
print(res.stdout)
...
res2 = subprocess.run(["wsl", "docker", "exec", "clab-pcap2story-rr1", "vtysh", "-c", "show bgp l2vpn evpn route"], capture_output=True, text=True)
print(res2.stdout)
