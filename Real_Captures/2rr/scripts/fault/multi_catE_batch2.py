"""
Category E, 2rr: recovery window variation for rr_down (bgpdkill),
pe_cease, rt_misconfig, and rd_collision (fixed variant), each at 60/120/300s.
Also attempts a 300s link_down BFD file; if veth-loss is detected mid-capture,
that file is abandoned and logged.
"""
...
def veth_ok(pe="pe2"):
    ...
    return "eth1" in r.stdout or "eth2" in r.stdout


def gen_link_down_300(pe="pe2"):
...
def gen_rt_misconfig(delay, pe="pe1"):
...
def gen_rd_collision(delay, pe_a="pe4", pe_b="pe5"):
