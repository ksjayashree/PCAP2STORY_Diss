# This file is the draft/critique/reconcile core of multi-agent debate
# (round 1 only). The multi-round extension (up to 10 rounds) lives in
# experiments/multi_agent_debate/mad_multiround_v2.py, and the post-hoc
# RESOLVED/NOT_RESOLVED scorer lives in
# experiments/multi_agent_debate/judge_mad_resolution.py -- both are
# separate files, not merged into this one.
